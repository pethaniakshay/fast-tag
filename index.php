                ...
                <form role="form" name="login" method="post" action="">
                    <fieldset>
                        <div class="form-group">
                            <input class="form-control" required placeholder="Mobile" name="mobile" type="text" autofocus="">
                        </div>
                        <div class="form-group">
...
if (isset($_POST["login"])) {
    include "connect.php";
    $username=mysqli_real_escape_string($link,$_POST['mobile']);
    $password=mysqli_real_escape_string($link,$_POST['password']);


    $res = mysqli_query($link,"select * from ttusers WHERE mobile='$username' && passwd='$password'")or die();
    $count = 0;
